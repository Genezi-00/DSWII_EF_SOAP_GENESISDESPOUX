 ...
 *       &lt;sequence&gt;
 *         &lt;element name="docentes" type="{http://www.cibertec.edu.pe/ws/object}docentews" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetDocentesResponse {
    ...
    protected List<Docentews> docentes;
     ...
     * 
     */
    public List<Docentews> getDocentes() {
        if (docentes == null) {
            docentes = new ArrayList<Docentews>();
        }
